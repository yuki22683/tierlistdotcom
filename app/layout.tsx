...
export const metadata: Metadata = {
  title: "ティアリスト.com",
  description: "みんなで決める、最強のランキング。ティアリスト.comは、アニメ、ゲーム、あらゆるジャンルのティアリストを作成・共有・投票できるコミュニティサイトです。",
  icons: {
    icon: "/logo.png",
    shortcut: "/logo.png",
    apple: "/logo.png",
      ...
      >
        <AffiliateLinkProvider>
          ...
          <footer id="global-footer" className="w-full border-t border-border/40 py-6 text-center text-sm text-muted-foreground bg-gray-50 dark:bg-zinc-900 flex flex-col gap-2 items-center">
            <p>
              &copy; {new Date().getFullYear()} ティアリスト.com. All rights reserved. <span className="ml-2">Ver.0.0.61</span>
            </p>
