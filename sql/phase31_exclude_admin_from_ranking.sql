-- Phase 31: Exclude admin users from ranking

-- Update get_user_rankings function to exclude admin users
...
BEGIN
  ...
  WHERE
    u.is_admin IS NOT TRUE -- Exclude admin users from ranking
  GROUP BY
