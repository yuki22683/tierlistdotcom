  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="px-6 sm:px-10 py-4 rounded-lg font-bold text-lg text-white transition-all shadow-lg bg-emerald-600 hover:scale-105 hover:bg-emerald-700 whitespace-nowrap"
      >
        タイトル当てクイズ
      </button>
