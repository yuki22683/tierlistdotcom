-- Phase 20 & 21 Combined Fix
-- Run this to enable pagination for Tier Lists, Items, and Tags

-- 1. Update get_home_tier_lists to support pagination
...
-- 2. Update get_popular_items to support pagination
...
-- 3. Update get_popular_tags to support pagination
...
-- 4. Count function for popular items
...
-- 5. Count function for popular tags
