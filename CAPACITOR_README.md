...
✅ **スプラッシュスクリーン** - アプリ起動時のロゴ表示
✅ **ステータスバー** - OSのステータスバーの色とスタイル設定
✅ **ネイティブシェア** - OS標準のシェア機能
✅ **プッシュ通知** - 通知の受信と表示（要：サーバー側実装）
✅ **ディープリンク** - URLからアプリを直接開く
✅ **アプリライフサイクル** - フォアグラウンド/バックグラウンドの検知

これらの機能は**ネイティブアプリでのみ動作**し、Webアプリには影響しません。
